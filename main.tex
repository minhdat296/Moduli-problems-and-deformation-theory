...
\begin{document}
    ...
    \part{Spaces for algebraic geometry}
        \chapter{Schemes, algebraic spaces, and algebraic stacks}
            ...
            \input{Algebraic geometry/Schemes, algebraic spaces, and algebraic stacks/schemes}
        ...
        \chapter{Quasi-coherent modules}
            ...
            \input{Algebraic geometry/Quasi-coherent modules/QCoh_applications}
        ...
        \begin{appendices}
            ...
            \chapter{Spectral sequences}
                ...
                \input{Appendices/Spectral sequences/stable_infinity_categories}

                \input{Appendices/Spectral sequences/spectral_sequences}
    ...
    \part{Formal geometry}
        ...
        \chapter{Algebraisation}
            ...
            \input{Formal geometry/D-modules/algebraic_de_rham_cohomology}
    ...
    \part{Moduli problems and representability}
        ...
        \chapter{\texorpdfstring{$\Quot, \Hilb$, and Grasmannians}{}}
            ...
            \input{Moduli theory/Quot, Hilb, and Gr/quot_and_hilbert_schemes}

            \input{Moduli theory/Quot, Hilb, and Gr/mapping_spaces}

            \input{Moduli theory/Quot, Hilb, and Gr/grassmannians}
        ...
        \chapter{Moduli stacks of principal bundles}
            ...
            \input{Moduli theory/Bun_G/global_geometry_of_Bun_G}
        ...
        \chapter{Equivariant geometry and geometric invariant theory}
            ...
            \input{Moduli theory/Equivariant geometry/good_moduli_spaces}

            \input{Moduli theory/Equivariant geometry/adequate_moduli_spaces}

            \input{Moduli theory/Equivariant geometry/equivariance}
