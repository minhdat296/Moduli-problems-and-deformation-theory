\section{Formal algebraic spaces}
    ...
    \subsection{Formal schemes and formal algebraic spaces}
        \begin{lemma}[Universal property of thickenings] \label{lemma: universal_property_of_thickenings}
        ...
        \end{lemma}
            \begin{proof}
                \todo[inline]{Universal property of thickenings}
            \end{proof}